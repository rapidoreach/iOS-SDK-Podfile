...
#ifndef RAPIDOREACHSDK_SWIFT_H
#define RAPIDOREACHSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RapidoReachSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// <code>RapidoReach</code> is the main entry point for the SDK
SWIFT_CLASS("_TtC14RapidoReachSDK11RapidoReach")
...
@interface RapidoReach (SWIFT_EXTENSION(RapidoReachSDK))
